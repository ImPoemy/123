...
const SHEET_API = "https://script.google.com/macros/s/AKfycbwrG7XSrEeFu8C82afhOkGM5lOHBP3LNf9__OeMp0-ouRcv7t5uJuxP2eONsguS3ijJ/exec";
...
function rollDice(){
  ...
  const itv = setInterval(()=>{
    ...
    if (cnt>=10){
      ...
      sendDiceResult(currentPlayer, finalResult); // ⬅ 這裡送到試算表
      saveToday();
      setTimeout(()=>{
